...
type
  ...
  IOrderSQL = FluentOrm.Db.QueryPredicates.IOrderSQL;
  OrderSQL = FluentOrm.Db.QueryPredicates.OrderSQL;
  ...
  IQueryBuilder = interface
    ...
    function OrderBy(const AArgsColumns: array of String): IQueryBuilder; overload;
...
function TQueryBuilder.OrderBy(
  const AArgsColumns: array of String): IQueryBuilder;
var
  StrOrder: String;
begin
  for var Col in AArgsColumns do
    StrOrder := StrOrder + IfThen(StrOrder.IsEmpty,'',',') + Col;

  Result := OrderBy(StrOrder);
end;
